...
const Wrapper = ({closeBtnOuter="true",defaultOpen= "false",className,modalBtn,children,animation}) => {
    ...
    return (
        <div className={className}>
            <span className={modalBtn && "inline-block"} onClick={handleOpenEvent}>
                {modalBtn}
            </span>
            <ReactModal
                className={animation}
            ...
            >
                <div className="modal-outer w-full text-center py-[40px] px-[15px]">
                    {
                        (closeBtnOuter === true) && <div className="close-btn absolute top-[30px] text-[30px] right-[30px] w-[44px] h-[44px] flex items-center justify-center cursor-pointer text-white landscape:top-[20px] landscape:right-[20px]" onClick={handleCloseEvent}>×</div>
                    }
