        ...
        <Container>
          <Row className="items-center h-[720px] lg:h-[500px] sm:h-[550px] xs:h-[750px] overflow-hidden">
            <Col xl={5} md={6} className="sm:mb-[40px] overflow-hidden">
              ...
              <Buttons ariaLabel="a for pricing-packages" to="/page/pricing-packages" className="mr-[38px] rounded-[4px] font-medium font-serif uppercase md:mb-[15px]" themeColor={["#ec606c", "#eb7242"]} size="xl" color="#fff" title="Get started now" />
              {/* Modal Component Start */}
              <CustomModal.Wrapper className="inline-block"
                modalBtn={<Buttons ariaLabel="a for modal button" type="submit" className="font-medium font-serif xs:!p-0 uppercase btn-a after:h-[2px] md:text-md md:mb-[15px] after:bg-[#374162] hover:text-darkgray" color="#374162" size="xl" title="See live demo" />} >
          ...
          <Container>
            <Row className="items-center justify-center">
              ...
              <m.div className="col-10 col-xl-4 col-lg-5 offset-lg-1 col-md-6 ps-lg-0 text-left md:text-start sm:text-center" {...fadeIn}>
                ...
                <Buttons ariaLabel="a for experience" to="/home-seo-agency" className="rounded-[4px] font-medium font-serif uppercase hover:text-darkgray btn-slide-filling-right bg-gradient-to-r from-[#374162] to-[#374162]" size="lg" color="#fff" themeColor="#fff" title="DISCOVER LITHO" />
              </m.div>
            </Row>
          </Container>
        </section>
                        ...
                        {({ isSubmitting, status }) => (
                          <div className="relative subscribe-style-06">
                            <Form className="relative">
                              ...
                              <button aria-label="a for subscribe" type="submit" className={`text-xs tracking-[1px] py-[12px] px-[28px] uppercase${isSubmitting ? " loading" : ""}`}><i className="far fa-envelope mr-[10px]"></i>get started</button>
                            </Form>
                            <AnimatePresence>
          ...
          <Container>
            <Row className="justify-center items-center">
              ...
              <Col xl={5} md={4} className="text-center text-md-end">
                <Buttons ariaLabel="a for company" to="/" className="rounded-[4px] font-medium font-serif uppercase hover:text-white btn-slide-filling-right bg-gradient-to-r from-[#fff] to-[#fff] text-darkgray" size="xl" color="#000" themeColor="#374162" title="DISCOVER LITHO" />
              </Col>
            </Row>
          </Container>
        </m.section>
